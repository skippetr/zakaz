                ...
                function ($attribute) {
                    if ($this->user !== null) {
                        ...
                        if ($confirmationRequired && !$this->user->getIsConfirmed()) {
                            $this->addError($attribute, Yii::t('user', 'Вам нужно подтвердить ваш email адрес'));
                        }
                        if ($this->user->getIsBlocked()) {
                            $this->addError($attribute, Yii::t('user', 'Ваш аккаунт заблокирован'));
                        }
                    }
                }
            ],
                ...
                'passwordValidate' => [
                    ...
                    function ($attribute) {
                        if ($this->user === null || !Password::validate($this->password, $this->user->password_hash)) {
                            $this->addError($attribute, Yii::t('user', 'Неверный логин или пароль'));
                        }
                    }
                ]
            ]);
